...
export default (spec: RarityFractionSpec): CronJob => {
  ...
  // Problems to solve: value of the rarity fraction is aggregated data.
  // If we are going to window this, how are we going to find out which accounts have been included in the aggregate and which do not?
  //
  // Maintain a list of users that have already been included in the previous count?
  // Maintain the values from the previous run.
